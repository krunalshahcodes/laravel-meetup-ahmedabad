    ...
    <div class="container mx-auto py-8">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-500">A list of all the users in your company including their name,
                    title, email and role.</p>
            </div>
            <div>
                <a href="{{ route('user.create') }}"
                    class="bg-indigo-600 text-white px-3 py-2 rounded text-sm font-semibold cursor-pointer">Add user</a>
            </div>
        </div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <div
                                                        class="h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center text-xs font-semibold tracking-wide">
